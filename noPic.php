                        ...
                        <div class="row">
                            <table class="table-bordered w-100" style="color:black;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center" style="font-size:10px; text-transform:capitalize;"> <?= htmlspecialchars($no); ?> </td>
                                        <td>
                                        ...
                                        <td class="text-center" style="font-size:12px; line-height:1.0; text-transform:uppercase;"> <?= htmlspecialchars($row['qty']); ?> <?= htmlspecialchars($row['satuan']); ?> </td>
                                    ...
                                    <?php include "addRowNP.php"; ?>
                                    
                                    <?php if (!($total_discount == 0 && (!$disc_all || $disc_all == NULL) && $from !== "CV")): ?>
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:13px; line-height:1.0;"><strong>Sub Total</strong></td>
                                        <td class="text-end px-2" style="font-size:13px; line-height:1.0;">
                                            <span class="float-start">Rp</span>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:13px; line-height:1.0;"><strong>Discount Product</strong></td>
                                        <td class="text-end px-2" style="font-size:13px; line-height:1.0;">
                                            <span class="float-start">Rp</span>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:13px; line-height:1.0;"><strong>Special Discount</strong></td>
                                        <td class="text-end px-2" style="font-size:13px; line-height:1.0;">
                                            <span class="float-start">Rp</span>
                                    ...
                                    <?php if ($from === 'CV'): ?>
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:13px; line-height:1.0;"><strong>PPN 11%</strong></td>
                                        <td class="text-end px-2" style="font-size:13px; line-height:1.0;">
                                            <span class="float-start">Rp</span>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:13px; line-height:1.0;"><strong>Grand Total</strong></td>
