...
$quoID = isset($_POST['quoid']) ? $_POST['quoid'] : '';
...
// Generate kode acak 6 digit (huruf dan angka)
...
if (mysqli_query($jadwal_conn, $insert_kegiatan_query)) {
    // Simpan kode kegiatan dan quoID ke session
    $_SESSION['kode_kegiatan'] = $kode;
    $_SESSION['quoID'] = $quoID;

    // Redirect ke halaman simpan_kode.php
    header('Location: simpan_kode.php');
