<footer class="bg-dark text-white pt-5 pb-4 mt-5">
    ...
    <?php
    // 2. Cek cookie HANYA untuk menentukan apakah modal akan muncul OTOMATIS.
    $show_modal_automatically = !isset($_COOKIE['quotation_update_modal_shown']);
    
    // HANYA jika cookie belum ada, cetak skrip untuk menampilkan modal secara otomatis
    if ($show_modal_automatically):
    ?>
    <script>
    // Skrip ini hanya akan ada di halaman jika cookie belum diset.
    ...
    <?php
    endif; // Akhir dari if ($show_modal_automatically)
    endif; // Akhir dari if ($show_announcement_period)
    ?>
