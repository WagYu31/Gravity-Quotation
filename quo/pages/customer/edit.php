...
$id = (int)$_GET['id'];
$stmt = $conn->prepare("SELECT * FROM customer WHERE id = ? AND deleted_at IS NULL");
...
<div class="gv-main-content" style="padding: 28px 36px;">
    ...
    <div class="dashboard-hero" style="margin-bottom: 28px;">
        <div class="hero-content">
            <div class="hero-text">
                <h1 class="hero-title">Edit Data Customer</h1>
                <p class="hero-subtitle">Perbarui informasi untuk: <strong><?php echo htmlspecialchars($customer['name']); ?></strong></p>
            </div>
            ...
            <form action="actions.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="store_name" name="store_name" value="<?php echo htmlspecialchars($customer['store_name']); ?>"
                            style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; border-radius: 10px !important; border: 1.5px solid #e2e8f0 !important; padding: 12px 16px !important; transition: all 0.2s;"
                            onfocus="this.style.borderColor='#facc15'; this.style.boxShadow='0 0 0 3px rgba(250,204,21,0.1)'"
                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="address" name="address" rows="3"
                        ...
                        onfocus="this.style.borderColor='#facc15'; this.style.boxShadow='0 0 0 3px rgba(250,204,21,0.1)'"
                        onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'"><?php echo htmlspecialchars($customer['address']); ?></textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="tel" class="form-control" id="phone_number" name="phone_number" value="<?php echo htmlspecialchars($customer['phone_number']); ?>"
                            style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; border-radius: 10px !important; border: 1.5px solid #e2e8f0 !important; padding: 12px 16px !important; transition: all 0.2s;"
                            onfocus="this.style.borderColor='#facc15'; this.style.boxShadow='0 0 0 3px rgba(250,204,21,0.1)'"
                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="ket" name="ket" value="<?php echo htmlspecialchars($customer['ket']); ?>"
                        style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; border-radius: 10px !important; border: 1.5px solid #e2e8f0 !important; padding: 12px 16px !important; transition: all 0.2s;"
                        onfocus="this.style.borderColor='#facc15'; this.style.boxShadow='0 0 0 3px rgba(250,204,21,0.1)'"
                        onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                </div>
