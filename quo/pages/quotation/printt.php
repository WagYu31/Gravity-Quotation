...
<head>
    ...
    <style>
        ...
        .page {
            ...
            padding: 1.5cm; margin: 1cm auto; border: 1px #D3D3D3 solid;
        }
        ...
        .item-list { border: 1px solid #000; margin-top: 20px; }
        ...
        @media print {
            body, .page { margin: 0; padding: 0.5cm; border: none; box-shadow: none; }
    ...
    <header>
        <div class="header-container" style="margin-bottom: 10px;">
            ...
            <div class="logo" style="width: 50%; text-align: right;">
                <img src="../../assets/img/logo.png" alt="Loewix Logo" style="width: 120px;">
            </div>
        </div>
    ...
    <main>
        <div class="item-list">
            ...
            <div class="item-row">
                ...
                <div class="col-price">Rp <?php echo number_format($item['item_price'], 0, ',', '.'); ?></div>
                <div class="col-amount">Rp <?php echo number_format($item['total_amount'], 0, ',', '.'); ?></div>
            </div>
            <?php endforeach; ?>
        </div>
    </main>
